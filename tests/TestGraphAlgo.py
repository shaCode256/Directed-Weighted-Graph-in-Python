...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.algo = GraphAlgo()
        """The method create 2 graphs for this unittest. connected graph and the other one isn't connected"""
    ...
    #     print()
    #     # print(self.algo.load_from_json("G_100_800_0.json"))
    ...
    #     Load algo on "myGraph" file. Now, algo operates Connected again, instead of is_not_connected."""
    #
