...
//        System.out.println(g1.getEdge(5,6).getWeight());
    ...
    @Test
    void test_javaComparisonJson1() throws IOException {
        System.out.println("operating on file: G_10_80_1.json");
        System.out.println("reading from file..."+ag1.load("G_10_80_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    }

    @Test
    void test_javaComparisonJson2() throws IOException {
        System.out.println("operating on file: G_100_800_1.json");
        System.out.println("reading from file..."+ag1.load("G_100_800_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    }

    @Test
    void test_javaComparisonJson3() throws IOException {
        System.out.println("operating on file: G_1000_8000_1.json");
        System.out.println("reading from file..."+ag1.load("G_1000_8000_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    ...
    @Test
    void test_javaComparisonJson4() throws IOException {
        System.out.println("operating on file: G_10000_80000_1.json");
        System.out.println("reading from file..."+ag1.load("G_10000_80000_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    }

    @Test
    void test_javaComparisonJson5() throws IOException {
        System.out.println("operating on file: G_20000_160000_1.json");
        System.out.println("reading from file..."+ag1.load("G_20000_160000_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    }

    @Test
    void test_javaComparisonJson6() throws IOException {
        System.out.println("operating on file: G_30000_240000_1.json");
        System.out.println("reading from file..."+ag1.load("G_30000_240000_1.json"));
        System.out.println("shortestPathList is "+ag1.shortestPathList(0, 4));
        System.out.println("shortestPathDist is "+ag1.shortestPathDist(0, 4));
    }
